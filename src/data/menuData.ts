...
export const menuData: AppData = {
  combos: [
      ...
      description: 'Salgados variados, pastéis mistos, churros + refrigerante 1L',
      price: 32.99,
      items: ['Salgados variados', 'Pastéis mistos', 'Churros', 'Refrigerante 1L'],
    ...
    },
    {
      ...
      description: 'Deliciosos mini churros com recheio. Escolha entre doce de leite ou chocolate. Serve 1 pessoa.',
      price: 24.99,
      items: ['Mini churros'],
    ...
    },
    {
      ...
      description: 'O combo preferido de todos. Salgados mistos, mini pastel e churros',
      price: 41.99,
