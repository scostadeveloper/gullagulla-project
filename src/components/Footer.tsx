...
const Footer: React.FC<FooterProps> = ({ onOpenFAQ }) => {
  // Lógica para saber se está aberto agora (igual StoreMap)
  function isOpenNow() {
    const now = new Date();
    const openHour = 10;
    const closeHour = 24;
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-6 sm:mb-8">
          ...
          <div className="md:col-span-2 lg:col-span-1">
            <div className="flex items-center space-x-2 sm:space-x-3 mb-3 sm:mb-4">
              ...
              <div>
                <h3
                  className="text-xl sm:text-2xl font-bold text-orange-400 tracking-tight"
            ...
            <p className="text-gray-400 text-xs sm:text-sm leading-relaxed">
              <span className="sm:hidden">
                Salgados, churros e bolos da região.{" "}
                <span className="text-orange-400 font-semibold">
                  Festas e eventos!
                </span>
              </span>
              <span className="hidden sm:block">
                Os melhores salgados, mini churros e bolos da região. Tradição
                familiar em cada receita.
                <br className="hidden sm:block" />
                Entregamos e atendemos em todo o Bairro Urucânia e adjacências.
                <br className="hidden sm:block" />
                <span className="text-orange-400 font-semibold">
                  Atendemos encomendas de grandes quantidades para festas,
                  empresas e eventos!
                </span>
              </span>
            </p>
            ...
            <div className="space-y-3 sm:space-y-4 text-xs sm:text-sm">
              ...
              <div>
                ...
                <div className="flex items-start space-x-2 sm:space-x-3 mb-2">
                  ...
                  <p className="text-gray-400">
                    <span className="sm:hidden">
                      R. Cilon Cunha Brum, 225 - Paciência
                    </span>
                    <span className="hidden sm:block">
              ...
              <div className="hidden sm:block">
                ...
                <div className="flex items-start space-x-2 sm:space-x-3 mb-2 sm:mb-3">
                  ...
                  <p className="text-gray-400">
                    <span className="sm:hidden">
                      R. José Piauhy Dourado, 253 - Paciência
                    </span>
                    <span className="hidden sm:block">
          ...
          <div>
            ...
            <div className="space-y-2 text-xs sm:text-sm">
              ...
              <div className="space-y-1 ml-8">
                <div>
                  <span className="text-gray-400">Segunda a Domingo:</span>
                  <br />
                  <span className="text-gray-400">10:00 às 00:00</span>
                  <br />
                  {isOpenNow() ? (
